...
//  initializing the database and seeding initial data using EF Core in a .NET application
public class DbInitializer
{
    public static void InitDb(WebApplication app)
    {
        ...
        SeedDat(scope.ServiceProvider.GetService<AuctionDbContext>());
    }

    private static void SeedDat(AuctionDbContext context)
    {

        // access to the migration of the database
        context.Database.Migrate();

        // if there are auctions in the db
        ...
        // add a collection of entities to the database context in a single operation
